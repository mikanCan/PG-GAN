...
tick = 200  # 1 tick = 1000 images = (1000/batch_size) iter.
max_resl = 7  # 10-->1024, 9-->512, 8-->256
...
parser.add_argument('--train_data_root', type=str, default='./data_root/*/*')
parser.add_argument('--identity_image_root', type=str, default='./target_image/*/*')
parser.add_argument('--batch_table', type=float, default={4: 8, 8: 8, 16: 8, 32: 8, 64: 8, 128: 8, 256: 1, 512: 1,
                                                          1024: 1})  # change this according to available gpu memory.
parser.add_argument('--im_size', type=float, default=int(pow(2, 2)))
...
parser.add_argument('--nz', type=int, default=8)  # input dimension of noise.
...
parser.add_argument('--TICK', type=int, default=tick)
parser.add_argument('--max_resl', type=int, default=max_resl)
parser.add_argument('--trns_tick', type=int, default=int(tick / max_resl))  # transition tick
parser.add_argument('--stab_tick', type=int, default=int(tick / 10))  # stabilization tick
parser.add_argument('--num_l1_loss', type=int, default=10)  # stabilization tick
